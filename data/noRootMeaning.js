...
"ٱلْيَسَعَ":["Al-Yasaa (a.h.s.)",[{_m:"One of the prophets mentioned in Qur'an."}]],
...
"إِبْرَاهِيم":["Ibrahim (a.h.s.) ",[{_m:" He is one of the most prominent prophets. He is the common link between the three major religions of Judaism, Christianity, and Islam. He was tested by Allah by the most difficult tests, including the one to sacrifice his son."}]],
...
"إِدْرِيس":["Idris (a.h.s.) ",[{_m:"One of the prophets mentioned in Qur'an."}]],
"إِذ":["When (for past)",[]],
"إِذًا":["Then",[]],
...
"إِسْحَاق":["Ishaaq (a.h.s.)",[{_m:"Second son of Ibraheem (a.h.s.), father of Yakoob/Israel (a.h.s.)"}]],
"إِسْرَائِيل":["Israel (a.h.s.)",[{_m:"Also known as Yakoob. Son of Ishaaq (a.h.s.) and grand son of Ibraheem (a.h.s.) "}]],
"إِسْمَاعِيل":["Ismail (a.h.s.)",[{_m:"First son of Ibraheem (a.h.s.), born when he was 86 years old. Ibraheem almost sacrificed Ismail as a test from Allah."}]],
"إِلَىٰ":["To, towards, till ",[]],
"إِلْيَاس":["Ilyaas (a.h.s.)",[{_m:"One of the prophets mentioned in Qur'an."}]],
...
"ذَا":["This, that, who, which",[{_n:{fs:["ذَات"]}}, {_m:"Other demonstrative pronoun like {هَـٰذَا‎, ذَلِكَ‎} derived from it."}]],
